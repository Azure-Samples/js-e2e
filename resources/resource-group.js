...
async function resourceGroupActions(credential){
    ...
    try {
        const resourceManagement = new ResourceManagementClient(credential, subscriptionId);
        ...
        for await (const item of resourceManagement.resourceGroups.list(properties)){
